...
// Placeholder data for blog posts. This should match blog.php
$posts = [
    [
        'id' => 1,
    ...
    [
        'id' => 3,
        'title' => 'DevBugSolver Platform Update: New Features in Q4 2023',
...
<head>
    ...
    <title><?php echo $post ? htmlspecialchars($post['title']) : 'Post Not Found'; ?> - DevBug</title>
    ...
    <style>
        ...
        .post-meta { display: flex; justify-content: center; align-items: center; gap: 20px; color: var(--text-muted); font-size: 0.9rem; }
        .author-info { display: flex; align-items: center; gap: 10px; }
        .author-avatar { width: 36px; height: 36px; border-radius: 50%; overflow: hidden; }
        .author-avatar img { width: 100%; height: 100%; object-fit: cover; }
        .post-image { width: 100%; height: 450px; border-radius: 16px; object-fit: cover; margin-bottom: 40px; }
        ...
        .author-box { margin-top: 60px; padding: 30px; background: var(--bg-card); border-radius: 16px; display: flex; gap: 25px; align-items: center; border: 1px solid var(--border); }
        .author-box .author-avatar { width: 80px; height: 80px; flex-shrink: 0; }
        .author-bio h4 { font-size: 1.3rem; color: var(--text-primary); margin-bottom: 10px; }
        .author-bio p { color: var(--text-secondary); line-height: 1.7; margin: 0; }
            ...
            <?php if ($post): ?>
                <article>
                    ...
                    <div class="post-content">
                        <?php echo $post['content']; // Content is assumed to be safe HTML for this placeholder ?>
                    </div>
                    ...
                    <div class="author-box">
                        ...
                        <div class="author-bio">
                            ...
                            <p>A passionate developer and writer for DevBug, dedicated to sharing knowledge and helping the community grow.</p>
                        </div>
                    </div>
                </article>
            <?php else: ?>
                <div class="not-found">
                    ...
                    <a href="/devbug/blog.php" class="btn btn-primary">Back to Blog</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
